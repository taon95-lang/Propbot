        ...
        for group in series_groups:
            ...
            if len(group) >= 2:
                ...
                paired_series_rows.append({
                    ...
                    "rounds": combined_r,
                    "map1": {"map": group[-1].get("map_name", "unknown"), "kills": m1_kills, "deaths": m1_deaths, "headshots": m1_hs, "rounds": group[-1].get("rounds", 22)},
                    "map2": {"map": group[-2].get("map_name", "unknown"), "kills": m2_kills, "deaths": m2_deaths, "headshots": m2_hs, "rounds": group[-2].get("rounds", 22)},
                })
                total_k += combined_k
                total_d += combined_d
                total_r += combined_r
